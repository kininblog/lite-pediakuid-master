<xsl:stylesheet
  ...
  <!-- Menghasilkan HTML dengan encoding UTF-8 dan indentasi -->
  <xsl:output method="html" version="1.0" encoding="UTF-8" indent="yes"/>
  
  <!-- Template utama: mulai dari root -->
  <xsl:template match="/">
  ...
  <!-- Template untuk elemen feed -->
  <xsl:template match="atom:feed">
    <h1>
      <xsl:value-of select="atom:title"/>&#39;s Web Feed Preview
    </h1>
    <p>
      This RSS feed provides the latest posts from <xsl:value-of select="atom:title"/>&#39;s blog.
    ...
    <p>All you need to do to get started is to add the URL (web address) for this feed to a special app called a newsreader. Visit <a href="https://aboutfeeds.com/">About Feeds</a> to get started. It’s free.</p>
  </xsl:template>
  
  <!-- Template untuk setiap entry dalam feed -->
